...
return [
    ...
    'custom' => [
        'phone' => [
            'required' => '電話番号が必要です。',
            'numeric' => '数字のみ入力してください。',
            'regex' => 'フォーマットが間違っています。',
            'digits_between' => '(8min 〜 11max)の形で入力してください。',
        ],
        'email' => [
            'required' => 'メールアドレスが必要です。',
            'max' => '名前は50文字を超えることはできません。',
            'unique' => 'メールアドレスは既に存在しています。',
        ],
        'password' => [
            'required' => 'パスワードが必要です。',
            'min' => 'パスワードは8文字以上を入力してください。',
            'max' => 'パスワードは50文字を超えることはできません。',
        ...
        'dob' => [
            ...
            'after' => '1940/01/01以降の日付でなければなりません。',
            'before' => '2011/01/01より前の日付でなければなりません。',
        ],
        'profile' => [
            'required' => 'プロファイルをアプロードしてください。',
            'mimes' => 'jpeg,jpg,pngのファイルタイプで入力してください。',
            'max' => '1024KB以下で入力してください。',
            'image' => 'プロファイルはイメージでなければなりません。',
        ],
        'type' => [
        ...
        'description' => [
            ...
            'max' => 'デスクリプションは255文字を超えることはできません。',
        ],
        'uploadFile' => [
